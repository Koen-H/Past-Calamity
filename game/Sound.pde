...
AudioPlayer walk1;
AudioPlayer walk2;
AudioPlayer stone_steps;
AudioPlayer door;
AudioPlayer projectorButton;

AudioPlayer cityAmbience;
AudioPlayer labAmbience;
AudioPlayer criticalAlarm;
...
public void soundLoad() {
  ...
  projectorButton = minim.loadFile("projector-button.mp3");
  ...
  stone_steps = minim.loadFile("stone-steps.mp3");
  ...
  criticalAlarm = minim.loadFile("critical-alarm.wav");
}
